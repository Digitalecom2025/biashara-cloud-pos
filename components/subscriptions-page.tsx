  ...
  return (
    <div className="mx-auto max-w-[1700px]">
      ...
      <section className="mt-5 overflow-hidden rounded-2xl border border-[#DDEAE0] bg-white">
        <div className="flex items-center gap-3 border-b border-[#E8F0EA] p-4"><span className="grid h-10 w-10 place-items-center rounded-xl bg-[#16A34A]/10 text-[#16A34A]"><ReceiptText size={18} /></span><div><h3 className="font-black text-[#173324]">Payment history</h3><p className="text-xs text-[#789083]">Subscription renewal records. Manual billing confirmation is used for now.</p></div></div>
